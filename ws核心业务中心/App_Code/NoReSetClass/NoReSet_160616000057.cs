...
public class NoReSet_160616000057
{
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        string zibiao_gts_id = "grid-table-subtable-160616000940";
    ...
    public DataSet NRS_EDIT_INFO(DataTable parameter_forUI)
    {
        ...
        return_ht = I_DBL.RunParam_SQL("select  top 1 *,(select top 1 r_ru from  ZZZ_C_record_sub where rid=@rid) as yincangkucun, (select top 1 wh_ru_wmname from  View_ZZZ_C_record_sub_ex where rid=@rid) as t_rukucangku, (select top 1 wh_ru_dpname from  View_ZZZ_C_record_sub_ex where rid=@rid) as t_rukukuwei,(select top 1 r_chu from  ZZZ_C_record_sub where rid=@rid) as chukuwei, (select top 1 wh_chu_wmname from  View_ZZZ_C_record_sub_ex where rid=@rid) as t_chukucangku, (select top 1 wh_chu_dpname from  View_ZZZ_C_record_sub_ex where rid=@rid) as t_chukukuwei  from View_ZZZ_C_record_ex where rid=@rid", "数据记录", param);
