...
public class NoReSet_160610000055
{
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        param.Add("@DDyuanyin", ht_forUI["DDyuanyin"].ToString());

        alsql.Add("INSERT INTO  ZZZ_BXSQ_DD(DDID, DD_BID, DDoldfzr, DDnewfzr, caozuoren,DDyuanyin) VALUES(@DDID, @DD_BID, @DDoldfzr, @DDnewfzr,@caozuoren,@DDyuanyin)");
        ...
        if ((bool)(return_ht["return_float"]))
        {
            ...
            dsreturn.Tables["返回值单条"].Rows[0]["提示文本"] = "调度申请成功！需审核后生效！{" + guid + "}";
        }
        else
        {
