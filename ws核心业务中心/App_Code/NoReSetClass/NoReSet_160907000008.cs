...
public class NoReSet_160907000008
{
    ...
    public string check_zhuangtai(string FCID)
    {
        ...
        return_ht = I_DBL.RunParam_SQL("select top 1 FCzhuangtai from ZZZ_xiaoshoudingdan where FCID=@FCID", "数据记录", param);
    ...
    public DataSet NRS_ADD(DataTable parameter_forUI)
    {
        ...
        Hashtable param = new Hashtable();
        //以可排序guid方式生成
        string guid = CombGuid.GetMewIdFormSequence("ZZZ_xiaoshoudingdan");
        param.Add("@FCID", guid);
        ...
        alsql.Add("INSERT INTO ZZZ_xiaoshoudingdan(FCID,FC_YYID,FCbumen,FCbeizhu,FCshenqingren,FCshenqingshijian,FCzhuangtai) VALUES(@FCID,@FC_YYID,@FCbumen,@FCbeizhu,@FCshenqingren,getdate(),'草稿')");


        //遍历子表， 插入 
        string zibiao_gts_id = "grid-table-subtable-160907000140";
        ...
        {
            param.Add("@sub_" + "FCSID" + "_" + i, CombGuid.GetMewIdFormSequence("ZZZ_xiaoshoudingdan_sb"));
            ...
            string INSERTsql = "INSERT INTO ZZZ_xiaoshoudingdan_sb ( FCSID, FCS_FCID, FCSbh,FClb, FCSsl,FCdanjia,FCjine, FCSbz ) VALUES(@sub_" + "FCSID" + "_" + i + ", @sub_MainID, @sub_" + "FCSbh" + "_" + i + ",@sub_" + "FClb" + "_" + i + ", @sub_" + "FCSsl" + "_" + i + " , @sub_" + "FCdanjia" + "_" + i + "  , @sub_" + "FCjine" + "_" + i + " , @sub_" + "FCSbz" + "_" + i + "  )";
            alsql.Add(INSERTsql);
        }
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        param.Add("@FCID", ht_forUI["idforedit"].ToString());
            ...
            alsql.Add("UPDATE  ZZZ_xiaoshoudingdan SET FC_YYID=@FC_YYID,FCbumen=@FCbumen,FCbeizhu=@FCbeizhu where FCID =@FCID ");
            ...
            alsql.Add("delete ZZZ_xiaoshoudingdan_sb where  FCS_FCID = @sub_" + "MainID");
            for (int i = 0; i < subdt.Rows.Count; i++)
            {
    ...
    public DataSet NRS_EDIT_INFO(DataTable parameter_forUI)
    {
        ...
        return_ht = I_DBL.RunParam_SQL("select top 1 * from View_ZZZ_xiaoshoudingdan_ex where FCID=@FCID", "数据记录", param);
