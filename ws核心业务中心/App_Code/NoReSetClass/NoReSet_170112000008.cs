...
public class NoReSet_170112000008
{
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        param.Add("@CD_be", ht_forUI["CD_be"].ToString());
        param.Add("@CD_hqd", ht_forUI["CD_hqd"].ToString());
        param.Add("@CD_je", ht_forUI["CD_je"].ToString());
        param.Add("@CD_clyj", ht_forUI["CD_clyj"].ToString());

        alsql.Add("UPDATE ZZZ_FWBG SET CD_be=@CD_be,CD_hqd=@CD_hqd,CD_je=@CD_je,CD_clyj=@CD_clyj where GID=@GID ");
        ...
        if ((bool)(return_ht["return_float"]))
        {
            ...
            dsreturn.Tables["返回值单条"].Rows[0]["提示文本"] = "存档成功";
        ...
        else
        {
            ...
            dsreturn.Tables["返回值单条"].Rows[0]["执行结果"] = "err";
            dsreturn.Tables["返回值单条"].Rows[0]["提示文本"] = "系统故障，存档失败：" + return_ht["return_errmsg"].ToString();
