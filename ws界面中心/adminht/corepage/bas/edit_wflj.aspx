<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_wflj.aspx.cs" Inherits="bas_edit_wflj" %>
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            function callback_zdy_ajaxdb(xml) {
                ...
                $("#LID").val($(xml).find('数据记录>bianhao').text());
                $("#Lmingcheng").val($(xml).find('数据记录>mingcheng').text());
                $("#Lguige").val($(xml).find('数据记录>guige').text());
                $("#Ldanwei").val($(xml).find('数据记录>danwei').text());
                $("#Lerpbianhao").val($(xml).find('数据记录>bianhao').text());
