<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_record.aspx.cs" Inherits="bas_edit_record" %>
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 window.setInterval(function () {
                     ...
                     //设置子表输入框只读
                     $("#gview_grid-table-subtable-160224000354").find("input").attr("readonly", "readonly");
