<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_xiaoliang.aspx.cs" Inherits="jwm_list_xiaoliang" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 //
                 //alert($.cookie('user_Uloginname_onlyforinput'));
                 var caozuoyuan = $.cookie('user_Uloginname_onlyforinput');
                 $("#zheshiliebiaoquyu").attr('teshuwhere', "FUserName='" + caozuoyuan + "'");
