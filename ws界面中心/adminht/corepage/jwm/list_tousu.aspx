<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_tousu.aspx.cs" Inherits="jwm_list_tousu" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 $("#zheshiliebiaoquyu").attr('teshuwhere', "caozuoyuan='" + caozuoyuan + "'");
