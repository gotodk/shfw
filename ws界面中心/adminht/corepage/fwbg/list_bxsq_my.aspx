<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_bxsq_my.aspx.cs" Inherits="fwbg_list_bxsq_my" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 $("#zheshiliebiaoquyu").attr('teshuwhere', "    (Bsbr='" + nowloginuser + "' or Bfwfzr='" + nowloginuser + "' )");
