<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_sqddd.aspx.cs" Inherits="fwbh_edit_sqddd" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 //临时修改一下标题，这个模块是拿修改当新增
                 $("#title_f_id").html($("#title_f_id").html().replace("修改","新增"));
 


                 var dfx_str_kh = "#show_searchopenyhbspgogo_DDnewfzr";
                     ...
                     if ($(dfx_str_kh).text() != oldzhi_kh) {
                         ...
                         if (arr != null) {//如果能匹配成功即arr数组不为空，循环输出结果
                             for (var i = 0; i < arr.length; i++) {
                                 ...
                                 if (arr_z[0] == "[姓名")
                                 { $("#DDnewfzr_name").val($.trim(arr_z[1]).replace("]", "")); }
