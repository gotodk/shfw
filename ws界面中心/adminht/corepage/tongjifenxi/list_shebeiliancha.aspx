<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_shebeiliancha.aspx.cs" Inherits="tongjifenxi_list_shebeiliancha" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 $("#zheshiliebiaoquyu").attr('teshuwhere', " YYID='" + cs + "' ");
