<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_fanxiubaobiao.aspx.cs" Inherits="tongjifenxi_fanxiubaobiao" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            $("#mysearchtop").empty();
            var lianjie = "<a href='list_fanxiubaobiao.aspx?lxlx=year'>查看年度</a>、<a href='list_fanxiubaobiao.aspx?lxlx=quarter'>查看季度</a>、<a href='list_fanxiubaobiao.aspx?lxlx=month'>查看月度</a>";
            $("#mysearchtop").html(lianjie);
                 var cs_name = "lxlx";
                 var cs = getUrlParam(cs_name);
                 if (cs != null && cs != "") {
                     $('a[href$="lxlx=' + cs + '"]').addClass("red");
                 }
                 else {
                     $('a[href$="lxlx=year"]').addClass("red");
                 }
