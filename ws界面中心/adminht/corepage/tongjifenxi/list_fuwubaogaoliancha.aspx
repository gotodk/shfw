<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_fuwubaogaoliancha.aspx.cs" Inherits="tongjifenxi_list_fuwubaogaoliancha" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 if (cs != "" && cs != null)
                 {
                     $("#zheshiliebiaoquyu").attr('teshuwhere', " G_YYID='" + cs + "' ");
                 }

                 var cs_name_sb = "SID";
                 var cs_sb = getUrlParam(cs_name_sb);
                 if (cs_sb != "" && cs_sb != null) {
                     $("#zheshiliebiaoquyu").attr('teshuwhere', " GID in (select sb_GID from ZZZ_FWBG_shebei where sb_SID='" + cs_sb + "')   ");
                 }
