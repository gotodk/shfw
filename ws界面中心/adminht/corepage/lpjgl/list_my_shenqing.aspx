<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_my_shenqing.aspx.cs" Inherits="lpjgl_list_my_shenqing" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 $("#zheshiliebiaoquyu").attr('teshuwhere', "rbzr='<%=UserSession.唯一键%>'");
