<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_Inventory_my.aspx.cs" Inherits="lpjgl_list_Inventory_my" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            $("#zheshiliebiaoquyu").attr('teshuwhere', "dpname = (select top 1 xingming from ZZZ_userinfo where UAid='<%=UserSession.唯一键%>')");
