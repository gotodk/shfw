<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_record_shenqing_edit.aspx.cs" Inherits="lpjgl_edit_record_shenqing_edit" %>
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 window.setInterval(function () {
                     ...
                     $("#gview_grid-table-subtable-160602000842").find("input[id^='自动生成']").attr("readonly", "readonly");

                     $("#gview_grid-table-subtable-160602000842").find("input[name='调整数量']").removeAttr("readonly");

                     $("#gview_grid-table-subtable-160602000842").find("input[name='批号']").removeAttr("readonly");
